...
import com.ugo.oze.databinding.FragmentFavoritesBinding
...
class FavoritesFragment : BaseFragment<FragmentFavoritesBinding, FavoritesViewModel>(), PlacesTrait {
  ...
  override fun bindView(binding: FragmentFavoritesBinding) {
    binding
